{
  ...
  "RowCount": 71,
  "Formulas": {
    "24,113": "ODATA(\"t_object_surveying/$count?$filter=object_order_id eq \"&IF(ISBLANK(BK25),\"null\",BK25)&\" and surveying_id gt \"&IF(ISBLANK(BL25),\"null\",BL25))",
    "24,106": "ODATA(\"t_object_attachment/$count?$filter=file_attribute_id eq \"&IF(ISBLANK(測量報告書ファイル属性ID),\"null\",測量報告書ファイル属性ID)&\" and surveying_id eq \"&IF(ISBLANK(BL25),\"null\",BL25)&\" and publish_flg eq 1 and active_flg eq 1\")",
    "24,105": "IFERROR(ODATA(\"v_surveying_product_summary?$select=仕入合計&$filter=測量ID eq \"&IF(ISBLANK(BL25),\"null\",BL25)),0)",
    "24,108": "ODATA(\"t_object_attachment/$count?$filter=file_attribute_id eq \"&IF(ISBLANK(仮杭報告書ファイル属性ID),\"null\",仮杭報告書ファイル属性ID)&\" and surveying_id eq \"&IF(ISBLANK(BL25),\"null\",BL25)&\" and publish_flg eq 1 and active_flg eq 1\")",
    "24,68": "IF(BN25=1,\"以降\",\"～\")",
    "24,112": "IF(DH25<>\"\",\"最終更新日時：\"&DH25,\"\")",
    "24,64": "$BK$30-ROW(BK25)+1",
    "29,62": "COUNT(BL25)",
    "24,107": "\"測量報告書(\"&DC25&\")\"",
    "24,104": "IFERROR(ODATA(\"v_surveying_product_summary?$select=売上合計&$filter=測量ID eq \"&IF(ISBLANK(BL25),\"null\",BL25)),0)",
    "24,109": "\"仮杭報告書(\"&DE25&\")\""
  },
  "CustomNames": [
    {
