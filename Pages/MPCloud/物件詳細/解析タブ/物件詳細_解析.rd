{
  ...
  "Formulas": {
    ...
    "15,8": "AY18",
    "15,25": "BA18",
    "28,119": "IF(OR(CV29=1,CS29=1,CU29=1,CT29=1),1,0)",
    "15,18": "AZ18",
    "28,118": "IF(DN29<>\"\",\"最終更新日時：\"&DN29,\"\")",
    "28,111": "\"解析ファイル(\"&DG29&\")\"",
    "15,35": "BB18",
    "28,110": "IFERROR(ODATA(\"v_analysis_file_count?$select=ファイル数&$filter=解析ID eq \"&IF(ISBLANK(BC29),\"null\",BC29)),0)",
    "28,109": "調査データ添付フラグ",
    "28,108": "工事見積不要フラグ",
    "28,107": "改良判定時基礎図必要フラグ",
    "28,106": "沈下量検討書必要フラグ",
    "28,102": "IFERROR(ODATA(\"v_analysis_product_summary?$select=仕入合計&$filter=解析ID eq \"&IF(ISBLANK(BC29),\"null\",BC29)),0)",
    "28,101": "IFERROR(ODATA(\"v_analysis_product_summary?$select=売上合計&$filter=解析ID eq \"&IF(ISBLANK(BC29),\"null\",BC29)),0)",
    "28,90": "IF(CK29<>\"\",CL29,\"\")",
