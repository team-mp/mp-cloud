{
  ...
  "RowCount": 65,
  "Formulas": {
    "28,120": "IF(AND(CS29=0,CV29=1),BE37,\"\")",
    "28,119": "IFERROR(ODATA(\"v_analysis_later_count?$select=後発件数&$filter=解析ID eq \"&IF(ISBLANK(BC29),\"null\",BC29)),0)",
    "33,50": "COUNT(BC29)",
    "15,8": "AY18",
    "15,25": "BA18",
    "28,118": "IF(OR(CU29=1,CR29=1,CT29=1,CS29=1),1,0)",
    "15,18": "AZ18",
    "28,117": "IF(DM29<>\"\",\"最終更新日時：\"&DM29,\"\")",
    "28,110": "\"解析ファイル(\"&DF29&\")\"",
    "15,35": "BB18",
    "28,109": "IFERROR(ODATA(\"v_analysis_file_count?$select=ファイル数&$filter=解析ID eq \"&IF(ISBLANK(BC29),\"null\",BC29)),0)",
    "28,108": "調査データ添付フラグ",
    "28,107": "工事見積不要フラグ",
    "28,106": "改良判定時基礎図必要フラグ",
    "28,105": "沈下量検討書必要フラグ",
    "28,101": "IFERROR(ODATA(\"v_analysis_product_summary?$select=仕入合計&$filter=解析ID eq \"&IF(ISBLANK(BC29),\"null\",BC29)),0)",
    "28,100": "IFERROR(ODATA(\"v_analysis_product_summary?$select=売上合計&$filter=解析ID eq \"&IF(ISBLANK(BC29),\"null\",BC29)),0)",
    "28,89": "IF(CJ29<>\"\",CK29,\"\")",
    "28,55": "$AY$34-ROW(BA29)+1"
  },
  "ArrayFormulas": {
