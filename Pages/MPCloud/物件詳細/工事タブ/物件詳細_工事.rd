{
  ...
  "Formulas": {
    "20,128": "COUNT(CE21)",
    "33,121": "ODATA(\"t_object_construction/$count?$filter=object_order_id eq \"&IF(ISBLANK(CE34),\"null\",CE34)&\" and construction_id gt \"&IF(ISBLANK(CF34),\"null\",CF34))",
    "38,82": "COUNT(CF34)",
    "33,120": "IF(DP34<>\"\",\"最終更新日時：\"&DP34,\"\")",
    "33,117": "\"施工報告書(\"&DM34&\")\"",
    "20,120": "DM21+DN21+DO21+DP21",
    "20,114": "IF(ISNUMBER(SEARCH(\",\"&CF21&\",\",\",\"&表示中IDs&\",\")),1,0)",
    "11,26": "CF14",
    "11,13": "CE14",
    "33,116": "ODATA(\"t_object_attachment/$count?$filter=construction_id eq \"&IF(ISBLANK(CF34),\"null\",CF34)&\" and file_attribute_id eq \"&IF(ISBLANK(施工報告書ファイル属性ID),\"null\",施工報告書ファイル属性ID)&\" and active_flg eq 1\")",
    "29,130": "IF(DR26=1,CK7,\"\")",
    "33,115": "IF(OR(DI34=1,DJ34=1,DK34=1),1,0)",
    "20,113": "\"見積書(\"&DI21&\")\"",
    ...
    "33,107": "IFERROR(ODATA(\"v_construction_product_summary?$select=仕入合計&$filter=工事ID eq \"&IF(ISBLANK(CF34),\"null\",CF34)),0)",
    "14,17": "IF(DY21>0,\"※現在、\"&DY21&\"社の工事会社が設定されています\",\"\")",
    "33,106": "IFERROR(ODATA(\"v_construction_product_summary?$select=売上合計&$filter=工事ID eq \"&IF(ISBLANK(CF34),\"null\",CF34)),0)",
