{
  ...
  "ArrayFormulas": {
    ...
    "3,98,1,4": "IFERROR(ODATA(\"m_group_notice?$select=group_notice_id,content,register_label,update_label&$filter=group_id eq \"&IF(ISBLANK(CL4),\"null\",CL4)&\" and tab_id eq \"&IF(ISBLANK(CF4),\"null\",CF4)),\"\")"
  }
}